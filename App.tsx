...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-background text-primary min-h-screen selection:bg-accent selection:text-white overflow-x-hidden font-sans">
      ...
      <section id="home" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full text-center md:text-left mt-20">
            ...
            <RevealText delay={0.6}>
                <p className="text-secondary text-lg md:text-xl max-w-xl leading-relaxed mb-10">
                    We architect high-performance web platforms and mobile ecosystems using advanced generative AI pipelines to reduce development cycles by 50%.
                </p>
            </RevealText>
          ...
          <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                  <div className="lg:col-span-4">
                      ...
                      <h4 className="text-secondary uppercase tracking-widest text-xs font-bold">Engineering Excellence</h4>
                  </div>
                  <div className="lg:col-span-8">
                      <h2 className="text-3xl md:text-5xl leading-tight font-sans font-light text-primary mb-12">
                          Idea Manifest is a <span className="font-serif italic text-accent">full-stack</span> solution provider. We combine elite engineering with <span className="font-serif italic text-accent">AI acceleration</span> to build robust webapps and mobile experiences faster than traditional agencies.
                      </h2>
      ...
      {/* SERVICES SECTION */}
      <section id="services" className="py-32 px-6 md:px-12 bg-[#050a1f]">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <ServiceCard 
                      ...
                      description="Scalable React/Next.js frontends coupled with robust Python/Node.js microservices. We build complex webapps that perform under load."
                      Icon={Monitor}
                  />
                  <ServiceCard 
                      number="02"
                      title="Cross-Platform Mobile"
                      description="High-fidelity mobile applications built with Flutter or React Native, delivering native performance on both iOS and Android from a single codebase."
                      Icon={Smartphone}
                  />
                  <ServiceCard 
                      number="03"
                      title="SaaS Architecture"
                      description="Multi-tenant architecture design, subscription billing integration, and secure authentication systems for modern SaaS products."
                      Icon={Cloud}
                  />
                  <ServiceCard 
                      number="04"
                      title="AI & LLM Integration"
                      description="We embed custom GPT models and RAG (Retrieval-Augmented Generation) pipelines directly into your software to automate complex workflows."
                      Icon={Bot}
                  />
                  <ServiceCard 
                      number="05"
                      title="API Development"
                      description="RESTful and GraphQL API design ensuring seamless communication between your services, third-party tools, and frontend clients."
                      Icon={Server}
                  />
                  <ServiceCard 
                      number="06"
                      title="DevOps & Cloud"
                      description="Automated CI/CD pipelines, Docker containerization, and serverless deployment on AWS/Azure for maximum uptime."
                      Icon={Settings}
                  />
              </div>
          </div>
      ...
      <section className="py-32 px-6 md:px-12 bg-background overflow-hidden">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-24">
                  <CollaborateSection 
                      title="Startup MVPs"
                      description="Speed is your only advantage. We utilize AI-assisted coding to launch functional, investable MVPs in weeks, not months. We handle the full stack so you can focus on user acquisition."
                      image="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2340&auto=format&fit=crop"
                      align="left"
                  />
                  <CollaborateSection 
                      title="Enterprise Modernization"
                      description="We help large organizations decouple monolithic legacy systems into agile microservices. Our solutions integrate securely with existing ERPs while introducing modern AI capabilities."
                  ...
                  <CollaborateSection 
                      ...
                      description="Replace spreadsheets and manual data entry with custom web applications. We build internal tools and dashboards that automate operations and provide real-time business intelligence."
      ...
      {/* TECHNOLOGY SECTION */}
      <section id="technology" className="py-24 px-6 md:px-12 bg-[#050a1f] border-t border-white/5">
          <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto bg-surface border border-white/10 rounded-[2rem] overflow-hidden relative shadow-2xl">
              ...
              <div className="relative z-10 px-8 py-20 md:p-24 flex flex-col md:flex-row items-center justify-between gap-12">
                  <div className="md:w-1/2">
                      <h2 className="font-serif text-4xl md:text-6xl text-white mb-6">Ready to <span className="italic text-accent">Build</span>?</h2>
                      <p className="text-secondary text-lg mb-8">Discuss your project architecture and get a technical roadmap today.</p>
                      ...
                      <div className="flex flex-col gap-4 text-secondary">
                          <div className="flex items-center gap-3">
                              ...
                              engineering@ideamanifest.com
                          </div>
                      </div>
                  </div>

                  <div className="md:w-1/2 w-full bg-[#0b1021] p-8 rounded-2xl shadow-2xl border border-white/5">
                       <form className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                              ...
                              <input type="email" placeholder="Email" className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-accent focus:bg-white/10 text-white placeholder-gray-500 transition-all" />
                          </div>
                          <textarea rows={4} placeholder="Project Details & Tech Requirements" className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-accent focus:bg-white/10 text-white placeholder-gray-500 transition-all resize-none"></textarea>
                          <button className="w-full py-4 bg-accent text-background rounded-lg font-bold hover:bg-white transition-colors shadow-[0_0_20px_rgba(129,140,248,0.3)]">Get Technical Proposal</button>
                       </form>
                  </div>
              </div>
          </div>
